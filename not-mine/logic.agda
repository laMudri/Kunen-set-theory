...
-- Checking if a crucial lemma can be proved without the solver machinery.
P∨P-easy : (P : Prop ℓ) -> P ∨ P -> P
P∨P-easy P (ι₁ x) = x
P∨P-easy P (ι₂ x) = x
...
... | inj₁ p | _ = inj₁ p
... | _ | inj₁ q = inj₂ q
... | inj₂ ¬p | inj₂ ¬q rewrite ¬p rewrite ¬q = magic (P∨P-easy ⊥ (≡-true PQ))
